    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        todos.map(function (todo, i) {
          return _react2.default.createElement(_todo_list_item2.default, { key: i, todo: todo });
        }),
...
var allTodos = function allTodos(state) {
  ...
  return todoIds.map(function (id) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function linkState(key) {
      ...
      return function (event) {
        return _this2.setState(_defineProperty({}, key, event.currentTarget.value));
      };
    }
  }, {
    key: 'addToDo',
    value: function addToDo() {
      ...
      return function () {
        var newTodo = {};
        newTodo['title'] = _this3.state.title;
        newTodo['body'] = _this3.state.body;
        _this3.props.receiveTodo(newTodo);
      };
    }
  }, {
    key: 'render',
